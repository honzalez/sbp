...
<header class="navbar-pro">
    <nav class="menu-pro">
        ...
        <ul class="main-menu-inline" id="mainMenuInline">
            <li><a href="/index.php"<?= basename($_SERVER['PHP_SELF']) == "index.php" ? ' class="active"' : '' ?>>Domů</a></li>
            ...
            <li><a href="/about.php"<?= basename($_SERVER['PHP_SELF']) == "about.php" ? ' class="active"' : '' ?>>O&nbsp;klubu</a></li>
